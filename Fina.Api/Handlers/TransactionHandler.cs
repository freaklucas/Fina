...
public class TransactionHandler(AppDbContext context) : ITransactionHandler
{
    ...
    public async Task<Response<Transaction?>> CreateAsync(CreateTransactionRequest request)
    {
        try
        {
            ...
            return new Response<Transaction?>(transaction, 201, "Transação criada.");
        }
        catch
        {
            return new Response<Transaction?>(null, 500, "Transação não criada.");
        }
    }
    ...
    public async Task<Response<Transaction?>> UpdateAsync(UpdateTransactionRequest request)
    {
        ...
        try
        {
            ...
            return new Response<Transaction?>(transaction, 200, "Transação atualizada.");
        }
        catch
        {
            return new Response<Transaction?>(null, 404, "Transação não criada.");
        }
    }
